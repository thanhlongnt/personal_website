    ...
    return (
        <section className={styles.section}>
            <div className={styles.socialLinks}>
                <a href="https://www.linkedin.com/in/tlnt" target="_blank" rel="noopener noreferrer" className={styles.socialLink}>
                ...
                <a href="https://github.com/thanhlongnt" target="_blank" rel="noopener noreferrer" className={styles.socialLink}>
                    <svg className={styles.socialIcon} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                ...
                <a href="mailto:tnguyentrong@ucsd.edu" className={styles.socialLink}>
                    <svg className={styles.socialIcon} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
